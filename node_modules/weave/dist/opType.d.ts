...
export type Op<T extends (...args: any[]) => any> = {
    ...
    invoke: CallMethod<T>;
} & T & ((...args: Parameters<T>) => ReturnType<T> extends AsyncIterable<infer U> ? AsyncIterable<Awaited<U>> : Promise<Awaited<ReturnType<T>>>);
 ...
 */
export type OpDecorator<T extends (...args: any[]) => any> = ((value: T, context: ClassMethodDecoratorContext) => T | void) & ((target: Object, propertyKey: string | symbol, descriptor: TypedPropertyDescriptor<T>) => TypedPropertyDescriptor<T> | void);
/**
...
type AsyncResult<F extends (...args: any[]) => any> = Promise<Awaited<ReturnType<F>>>;
...
export interface CallMethod<F extends (...args: any[]) => any> {
    (this: any, ...params: Parameters<F>): Promise<[Awaited<ReturnType<F>>, Call]>;
}
export declare function isOp(value: any): value is Op<any>;
export declare function getOpWrappedFunction<T extends (...args: any[]) => any>(opValue: Op<T>): T;
export declare function getOpName(opValue: Op<any>): string;
export declare function getOpParameterNames(opValue: Op<any>): ParameterNamesOption;
export declare class OpRef {
    projectId: string;
    objectId: string;
    digest: string;
...
export {};
//# sourceMappingURL=opType.d.ts.map