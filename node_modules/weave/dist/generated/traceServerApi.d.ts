...
export interface AndOperation {
    /** $And */
    $and: (LiteralOperation | GetFieldOperator | ConvertOperation | AndOperation | OrOperation | NotOperation | EqOperation | GtOperation | GteOperation | InOperation | ContainsOperation)[];
}
...
export interface ContainsSpec {
    /** Input */
    input: LiteralOperation | GetFieldOperator | ConvertOperation | AndOperation | OrOperation | NotOperation | EqOperation | GtOperation | GteOperation | InOperation | ContainsOperation;
    /** Substr */
    substr: LiteralOperation | GetFieldOperator | ConvertOperation | AndOperation | OrOperation | NotOperation | EqOperation | GtOperation | GteOperation | InOperation | ContainsOperation;
    /**
     * Case Insensitive
     * @default false
     */
...
export interface OrOperation {
    /** $Or */
    $or: (LiteralOperation | GetFieldOperator | ConvertOperation | AndOperation | OrOperation | NotOperation | EqOperation | GtOperation | GteOperation | InOperation | ContainsOperation)[];
}
/** Query */
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    health: {
         ...
         * @request GET:/health
         */
        readRootHealthGet: (params?: RequestParams) => Promise<HttpResponse<any, any>>;
    };
    serverInfo: {
        /**
         * No description
         ...
         */
        serverInfoServerInfoGet: (params?: RequestParams) => Promise<HttpResponse<ServerInfoRes, any>>;
    };
    call: {
        /**
         * No description
         ...
         * @secure
         */
        callStartCallStartPost: (data: CallStartReq, params?: RequestParams) => Promise<HttpResponse<CallStartRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Calls
         ...
         * @secure
         */
        callEndCallEndPost: (data: CallEndReq, params?: RequestParams) => Promise<HttpResponse<object, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Calls
         ...
         * @secure
         */
        callStartBatchCallUpsertBatchPost: (data: CallCreateBatchReq, params?: RequestParams) => Promise<HttpResponse<CallCreateBatchRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Calls
         ...
         * @secure
         */
        callUpdateCallUpdatePost: (data: CallUpdateReq, params?: RequestParams) => Promise<HttpResponse<object, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Calls
         ...
         * @secure
         */
        callReadCallReadPost: (data: CallReadReq, params?: RequestParams) => Promise<HttpResponse<CallReadRes, HTTPValidationError>>;
    };
    calls: {
        /**
         * No description
         ...
         * @secure
         */
        callsDeleteCallsDeletePost: (data: CallsDeleteReq, params?: RequestParams) => Promise<HttpResponse<object, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Calls
         ...
         * @secure
         */
        callsQueryStatsCallsQueryStatsPost: (data: CallsQueryStatsReq, params?: RequestParams) => Promise<HttpResponse<CallsQueryStatsRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Calls
         ...
         * @secure
         */
        callsQueryStreamCallsStreamQueryPost: (data: CallsQueryReq, params?: RequestParams) => Promise<HttpResponse<any, HTTPValidationError>>;
    };
    obj: {
        /**
         * No description
         ...
         * @secure
         */
        objCreateObjCreatePost: (data: ObjCreateReq, params?: RequestParams) => Promise<HttpResponse<ObjCreateRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Objects
         ...
         * @secure
         */
        objReadObjReadPost: (data: ObjReadReq, params?: RequestParams) => Promise<HttpResponse<ObjReadRes, HTTPValidationError>>;
    };
    objs: {
        /**
         * No description
         ...
         * @secure
         */
        objsQueryObjsQueryPost: (data: ObjQueryReq, params?: RequestParams) => Promise<HttpResponse<ObjQueryRes, HTTPValidationError>>;
    };
    table: {
        /**
         * No description
         ...
         * @secure
         */
        tableCreateTableCreatePost: (data: TableCreateReq, params?: RequestParams) => Promise<HttpResponse<TableCreateRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Tables
         ...
         * @secure
         */
        tableUpdateTableUpdatePost: (data: TableUpdateReq, params?: RequestParams) => Promise<HttpResponse<TableUpdateRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Tables
         ...
         * @secure
         */
        tableQueryTableQueryPost: (data: TableQueryReq, params?: RequestParams) => Promise<HttpResponse<TableQueryRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Tables
         ...
         * @secure
         */
        tableQueryStatsTableQueryStatsPost: (data: TableQueryStatsReq, params?: RequestParams) => Promise<HttpResponse<TableQueryStatsRes, HTTPValidationError>>;
    };
    refs: {
        /**
         * No description
         ...
         * @secure
         */
        refsReadBatchRefsReadBatchPost: (data: RefsReadBatchReq, params?: RequestParams) => Promise<HttpResponse<RefsReadBatchRes, HTTPValidationError>>;
    };
    file: {
        /**
         * No description
         ...
         * @secure
         */
        fileCreateFileCreatePost: (data: BodyFileCreateFileCreatePost, params?: RequestParams) => Promise<HttpResponse<FileCreateRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Files
         ...
         * @secure
         */
        fileContentFileContentPost: (data: FileContentReadReq, params?: RequestParams) => Promise<HttpResponse<any, HTTPValidationError>>;
    };
    cost: {
        /**
         * No description
         ...
         * @secure
         */
        costCreateCostCreatePost: (data: CostCreateReq, params?: RequestParams) => Promise<HttpResponse<CostCreateRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Costs
         ...
         * @secure
         */
        costQueryCostQueryPost: (data: CostQueryReq, params?: RequestParams) => Promise<HttpResponse<CostQueryRes, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Costs
         ...
         * @secure
         */
        costPurgeCostPurgePost: (data: CostPurgeReq, params?: RequestParams) => Promise<HttpResponse<object, HTTPValidationError>>;
    };
    feedback: {
        /**
         ...
         * @secure
         */
        feedbackCreateFeedbackCreatePost: (data: FeedbackCreateReq, params?: RequestParams) => Promise<HttpResponse<FeedbackCreateRes, HTTPValidationError>>;
        /**
         ...
         * @secure
         */
        feedbackQueryFeedbackQueryPost: (data: FeedbackQueryReq, params?: RequestParams) => Promise<HttpResponse<FeedbackQueryRes, HTTPValidationError>>;
        /**
         ...
         * @secure
         */
        feedbackPurgeFeedbackPurgePost: (data: FeedbackPurgeReq, params?: RequestParams) => Promise<HttpResponse<object, HTTPValidationError>>;
        /**
         * No description
         *
         * @tags Feedback
         ...
         * @secure
         */
        feedbackReplaceFeedbackReplacePost: (data: FeedbackReplaceReq, params?: RequestParams) => Promise<HttpResponse<FeedbackReplaceRes, HTTPValidationError>>;
    };
}
export {};
//# sourceMappingURL=traceServerApi.d.ts.map