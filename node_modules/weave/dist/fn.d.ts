...
export declare abstract class CallableObject<I, O> extends WeaveObject implements Callable<I, O> {
    abstract run(input: I): Promise<O>;
}
export declare function mapArgs<T extends Record<string, any>, M extends Record<string, keyof T>>(input: T, mapping: M): {
    [K in keyof M]: T[M[K]];
};
